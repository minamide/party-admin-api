...
describe('Reposts Router', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    app = new Hono();
    app.route('/', repostsRouter);
  });

  describe('POST /', () => {
    it('should create repost with valid data', async () => {
      const repostData = { userId: 'user-1', postId: 'post-1' };
